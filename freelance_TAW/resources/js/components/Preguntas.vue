          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
              <li role="presentation" class="active">
                <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Preguntas</a>
              </li>
                                      ...
                                      <center>
                                        <ul class="nav navbar-center panel_toolbox">
                                          ...
                                          <template v-if="producto.condicion">
                                              <a @click="desactivarPregunta(producto.id)" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-remove"></i></a>
                                          </template>
                                          <template v-else>
                                              <a @click="activarPregunta(producto.id)" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-check"></i></a>
                                          </template>
                                        </ul>
                                      </center>
                                    </td>
                                 <td>
                                    <a href="#" data-toggle="modal" data-target=".bs-example-modal-sm" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-eye"></i>Sample</a>
                                 </td>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal form-label-left" method="post">
                            ...
                            <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Pregunta: <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input v-model="Pregunta" class="form-control col-md-7 col-xs-12" data-validate-length-range="50" data-validate-words="2" placeholder="" type="text">
                            </div>
                            </div>
