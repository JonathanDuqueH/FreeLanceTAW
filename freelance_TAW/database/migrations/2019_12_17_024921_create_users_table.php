...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            DB::insert('insert into users (id, name, apellido_p, apellido_m, telefono, condicion, email, password, idrol) values (?, ?, ?, ?, ?, ?, ?, ?, ?)', [3, 'Liliana' ,'Lince', 'Andrade', '8345555555', '1','1530048@upv.edu.mx','$2y$10$NvNKMeSUyHhe/YecrNvAuuTxMqeSjg00YKcKSKd35M/Xh3AUpny7C','3']);
            DB::insert('insert into users (id, name, apellido_p, apellido_m, telefono, condicion, email, password, idrol) values (?, ?, ?, ?, ?, ?, ?, ?, ?)', [4, 'Jose' ,'Colchado', 'Sanchez', '8342515159', '1','1530424@upv.edu.mx','$2y$10$GgZvV9xWkIisdvI0MTw0/ekphJvtgMtZCtdU6FVzcghKhx8SWe556','4']);
